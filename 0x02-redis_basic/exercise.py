#!/usr/bin/env python3
""" This will writes strings to Redis, Reads from Redis and recovers original
    type, Increments values, Stores lists, Retrieves all lists """
...
def call_history(method: Callable) -> Callable:
    """ This store history of inputs and outputs for a particular function """
...
def count_calls(method: Callable) -> Callable:
    """ will count how many times methods of the Cache class are called """
    key = method.__qualname__
